...
@NamedQueries({
    ...
    @NamedQuery(name = "Zaduzenje.findByZaduzenjeid", query = "SELECT z FROM Zaduzenje z WHERE z.zaduzenjePK.zaduzenjeid = ?1"),
    @NamedQuery(name = "Zaduzenje.findByClanid", query = "SELECT z FROM Zaduzenje z WHERE z.zaduzenjePK.clanid = ?1"),
